...
use App\Models\DetallesIngresos\AgregarCategoriasIngreso;
use App\Models\DetallesIngresos\AgregarDetalleIngreso;
use App\Models\DetallesIngresos\ActualizarDetalleIngreso;
use App\Models\DetallesIngresos\EliminarDetalleIngreso;
use Carbon\Carbon;

class DetallesIngresos2Controller extends Controller
{
    ...
    public function consulta_CrearCategoria(Request $request){
        ...
        if (Auth::check()) {
            $agregarCategoriasEgresos = new AgregarCategoriasIngreso;
    ...
    public function consulta_TraerTablasDetallesEgresos(Request $request){
        ...
        if (Auth::check()) {
            ...
            SELECT 
                ...
                monto_detalle,
                observacion,
                tb_detalles_ingresos.id_category,
                tb_categorias_ingresos.nombre_category
            FROM tb_detalles_ingresos
            LEFT JOIN tb_categorias_ingresos ON tb_categorias_ingresos.id_category = tb_detalles_ingresos.id_category
    ...
    public function consulta_AgregarDetalleEgreso (Request $request){
        ...
        if (Auth::check()) {
            $agregarDetalleEgreso = new AgregarDetalleIngreso;
    ...
    public function consulta_EliminarDetalleEgreso (Request $request){
        ...
        if (Auth::check()) {
            $eliminarDetalleEgreso = new EliminarDetalleIngreso;
    ...
    public function consulta_AgregarDetalleEgresoEditar (Request $request){
        ...
        if (Auth::check()) {
            $actualizarDetalleEgreso = new ActualizarDetalleIngreso;
    ...
    public function consulta_TraerDetallesEgresos(Request $request){
        ...
        if (Auth::check()) {
            ...
            LEFT JOIN tb_categorias_ingresos c ON c.id_category = d.id_category
    ...
    public function consulta_TraerModalDetallesEgresos(Request $request){
        ...
        if (Auth::check()) {
            ...
            FROM tb_detalles_ingresos
            LEFT JOIN tb_categorias_ingresos ON tb_categorias_ingresos.id_category = tb_detalles_ingresos.id_category
            WHERE estadoDetalle = 1 AND fecha_detalle = ? AND tb_detalles_ingresos.id_category = ?',[$fecha,$categoria]);
