...
jQuery(function ($) {
                    ...
                    if (masDeUnPago == 0){
                        pagosDetallados += `
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 contarFilaPagos">
                                                ...
                                                <td class="text-center py-1 px-2 whitespace-nowrap"></td>
                                                <td class="text-center py-1 px-2 whitespace-nowrap"></td>
                                                <td class="text-center py-1 px-2 whitespace-nowrap font-semibold">S/. ${parseFloat(obj.cantidadAbonoPag).toFixed(2)}</td>
                                                <td class="text-center py-1 px-2 whitespace-nowrap"></td>
                                            </tr> `
                        masDeUnPago += 1
                    }else{
    ...
    //     // let nombrePDF = `${nombreCliente}-${fechaCuentaDelCliente}-${horaFormateada}.pdf`;
    //     // Guarda el PDF
    //     // doc.save(nombrePDF);
