        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.totalesQuintaEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoQuintaEspecie = parseInt(item.totalVentaDescuentoQuintaEspecie);
                });
                ...
                response.totalesSextaEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoSextaEspecie = parseInt(item.totalVentaDescuentoSextaEspecie);
                });
                ...
                response.totalesSeptimaEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoSeptimaEspecie = parseInt(item.totalVentaDescuentoSeptimaEspecie);
                });
                ...
                response.totalesOctavaEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoOctavaEspecie = parseInt(item.totalVentaDescuentoOctavaEspecie);
                });
                ...
                response.totalesDecimaEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoDecimaEspecie = parseInt(item.totalVentaDescuentoDecimaEspecie);
                });
                ...
                response.totalesDecimaPrimeraEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoDecimaPrimeraEspecie = parseInt(item.totalVentaDescuentoDecimaPrimeraEspecie);
                });
                ...
                response.totalesDecimaSegundaEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoDecimaSegundaEspecie = parseInt(item.totalVentaDescuentoDecimaSegundaEspecie);
                });
                ...
                response.totalesDecimaTerceraEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoDecimaTerceraEspecie = parseInt(item.totalVentaDescuentoDecimaTerceraEspecie);
                });
                ...
                response.totalesDecimaCuartaEspecie.forEach(function (item) {
                    ...
                    combinedData[fecha].totalVentaDescuentoDecimaCuartaEspecie = parseInt(item.totalVentaDescuentoDecimaCuartaEspecie);
                });
                ...
                console.log("Respuesta Aqui:",combinedData);
            },
            error: function (error) {
                console.error("ERROR", error);
            }
