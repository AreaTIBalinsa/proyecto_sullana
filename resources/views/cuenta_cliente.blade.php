            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="items-center justify-end rounded-xl gap-4 hidden">
                    <div class="flex items-center px-4 border border-gray-200 rounded dark:border-gray-700">
                        <input id="checkboxID" type="checkbox" value="" name="bordered-checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <p class="text-gray-900 dark:text-white hidden">
                    Al desactivar la cuenta por defecto se hace que los pagos en la cuenta que son de dias anteriores se sumen al abono de hoy y por tanto el saldo anterior se aumenta ya que ese pago no se esta considerendo en el dia que señala sino recien se restara hoy. Cuando la cuenta por defecto esta activada trae el saldo anterior real y los pagos de fechas anteriores ya no se cuentan ya que ya fueron restados en su dia que señala la fecha que tiene.
                </p>
            </div>
        </div>
        {{-- Tabla --}}
