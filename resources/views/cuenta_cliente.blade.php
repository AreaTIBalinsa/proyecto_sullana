...
@section('contenido')
    <main class="p-6 min-h-[calc(100%-161px)]">
        <div class="md:px-10 px-5 pb-5 bg-white dark:bg-gray-900 rounded-xl drop-shadow-md">
            ...
            <div class="flex justify-between items-center">
                ...
                <button class="bg-blue-500 p-1 rounded-full hidden" id="btnRetrocesoCuentaDelCliente"><i
                        class='bx bx-arrow-back text-white'></i></button>
                <button class="bg-blue-500 p-1 rounded-full hidden" id="btnRetrocesoCuentaDelClienteDescuento"><i
                        class='bx bx-arrow-back text-white'></i></button>
            </div>
            ...
            <div class="mt-0 mb-5 relative">
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-2">
                        <label for="inputNombreClientes" class="font-semibold text-gray-800 dark:text-white">Cliente
                            :</label>
                        <div class="relative flex w-full">
                            <div
                                class="inline-flex h-10 items-center px-3 text-sm text-gray-900 bg-gray-200 border border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400">
                                <i class='bx bxs-user-circle text-xl'></i>
                            </div>
                            <div class="w-full md:w-64 relative">
                                <input type="text" class="hidden" disabled="disabled" value="0"
                                    id="codigoClienteSeleccionado">
                    ...
                    <div class="flex gap-x-24 gap-4 w-full flex-col md:flex-row">
                        <div class="flex flex-col justify-center">
                            <label for="fechaCuentaDelCliente" class="text-base text-gray-900 dark:text-gray-50">Fecha
                                :</label>
                            <input type="date"
                                ...
                                id="fechaCuentaDelCliente">
                        </div>
                        <div class=" flex items-end">
                            <button
                                class="text-base py-2 px-5 bg-blue-600 hover:bg-blue-700 text-gray-50 rounded-lg w-full md:w-auto"
                                id="btnBuscarCuentaDelCliente"><i class='bx bx-search-alt'></i> Buscar</button>
                        </div>
                    </div>
                    <div class="flex items-center justify-end py-1 rounded-xl px-1 flex-wrap gap-4">
                        <button
                            class="text-base py-2 px-5 bg-green-600 hover:bg-green-700 text-gray-50 rounded-lg w-full md:w-auto md:flex gap-2 items-center justify-center hidden"
                            id="btnEnviarCuentaWhatsApp"><img src='{{ asset('img/WhatsApp.png') }}' alt=""
                                class="h-5"> Enviar Cuenta</button>
                        <button
                            class="text-base py-2 px-5 bg-green-600 hover:bg-green-700 text-gray-50 rounded-lg w-full md:w-auto flex gap-2 items-center justify-center md:hidden"
                            id="btnEnviarCuentaWhatsAppTelefono"><img src='{{ asset('img/WhatsApp.png') }}' alt=""
                                class="h-5"> Descargar Cuenta</button>
                        <button
                            class="text-base py-2 px-5 bg-green-600 hover:bg-green-700 text-gray-50 rounded-lg w-full md:w-auto flex gap-2 items-center justify-center md:hidden"
                            id="btnEnviarCuentaWhatsAppTelefonoAbrir"><img src='{{ asset('img/WhatsApp.png') }}'
                                alt="" class="h-5"> Ir a WhatsApp</button>
                        <div class="w-full md:w-56">
                            <div class="flex items-center">
                                <button
                                    class="flex p-2.5 z-20 text-sm text-gray-900 bg-gray-50 rounded-l-lg border-s-0 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                                    type="button">
                                ...
                                <div class="relative w-full">
                                    <input type="text" id="phoneInput"
                                        class="validarEntradasDeCelular block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-0 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                    ...
                    <div class="flex items-center justify-end py-1 rounded-xl px-1 gap-4">
                        <button
                            class="text-base py-2 px-5 bg-orange-500 md:max-w-xs w-full hover:bg-orange-600 text-gray-50 rounded-lg md:w-auto font-semibold"
                            id="btnEditarTablaCuentaCliente">Editar Tabla</button>
                        <button
                            class="text-base py-2 px-5 bg-red-600 md:max-w-xs w-full hover:bg-red-700 text-gray-50 rounded-lg md:w-auto font-semibold"
                            id="btnAgregarDiferencia">Agregar Diferencia</button>
                        <button
                            class="text-base py-2 px-5 bg-blue-600 md:max-w-xs w-full hover:bg-blue-700 text-gray-50 rounded-lg md:w-auto font-semibold"
                            id="btnCambiarPrecioPesadas">S/ Cambiar Precios</button>
                    </div>
                    <div class="items-center justify-end rounded-xl gap-4 hidden">
                        <div class="flex items-center px-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="checkboxID" type="checkbox" value="" name="bordered-checkbox"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="checkboxID"
                                class="w-full py-2 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Cuenta por
                                Defecto</label>
                        </div>
                    </div>
                    <p class="text-gray-900 dark:text-white hidden">
                        Al desactivar la cuenta por defecto se hace que los pagos en la cuenta que son de dias anteriores se
                        sumen al abono de hoy y por tanto el saldo anterior se aumenta ya que ese pago no se esta
                        considerendo en el dia que señala sino recien se restara hoy. Cuando la cuenta por defecto esta
                        activada trae el saldo anterior real y los pagos de fechas anteriores ya no se cuentan ya que ya
                        fueron restados en su dia que señala la fecha que tiene.
                    </p>
                </div>
            </div>
            {{-- Tabla --}}
            <div class="flex overflow-auto p-1">
                <div class="relative rounded-lg md:mb-5 border-2" id="hmtlCapture">
                    <h2 id="cuentaClienteNombre"
                        class="py-5 text-2xl font-bold text-center bg-[#92D14E] text-black border-b-2 border-black"></h2>
                    <div class="flex justify-center items-start">
                        <table class="border-collapse w-full text-black select-none relative text-sm"
                            id="tablaCuentaDelCliente">
                            <thead id="headerCuentaDelCliente" class="bg-[#92D14E] text-black">
                                ...
                                <tr class="h-10 bg-white">
                                    ...
                                    <th
                                        class="px-4 font-bold whitespace-nowrap border-r-2 border-b-2 border-black bg-white">
                                    </th>
                                    <th class="px-4 font-bold whitespace-nowrap border-r-2 border-b-2 border-t-2 border-black"
                                        colspan="4">VENTA</th>
                                </tr>
                                <tr class="h-10">
                                    <th
                                        class="px-4 font-bold whitespace-nowrap border-r-2 border-b-2 border-t-2 border-black w-[90px]">
                                        DIA</th>
                                    <th
                                        class="px-4 font-bold whitespace-nowrap border-r-2 border-b-2 border-black w-[200px]">
                                        REPRESENTACIÓN</th>
                                    <th
                                        class="px-4 font-bold whitespace-nowrap border-r-2 border-b-2 border-black w-[150px]">
                                        UNIDADES</th>
                                    <th
                                        class="px-4 font-bold whitespace-nowrap border-r-2 border-b-2 border-black w-[150px]">
                                        PESO</th>
                                    <th
                                        ...
                                        PRECIO</th>
                                    <th
                                        class="px-4 font-bold whitespace-nowrap border-b-2 border-r-2 border-black w-[150px]">
                                        IMPORTE</th>
                                </tr>
                            </thead>
                            <tbody id="bodyCuentaDelCliente" class="font-semibold">
                                <tr class="rounded-lg border-b-2 border-black bg-white">
                        ...
                        <table class="border-collapse text-black select-none relative text-sm" id="tablaCuentaDelCliente">
                            <thead id="headerCuentaDelCliente" class="bg-[#FEFF01] text-black">
                                ...
                                <tr class="h-10 bg-white">
                                    <th
                                        class="px-4 font-bold whitespace-nowrap border-b-2 border-t-2 border-r-2 border-black">
                                        COBRANZA</th>
                                    <th class="px-4 font-bold whitespace-nowrap border-t-2"></th>
                                </tr>
                                <tr class="h-10">
                                    <th
                                        class="px-4 bg-[#92D14E] font-bold whitespace-nowrap border-b-2 border-t-2 border-r-2 border-black">
                                        ABONO</th>
                                    <th class="px-4 font-bold whitespace-nowrap border-b-2 border-t-2 border-black">SALDO
                                        ANTERIOR</th>
                                </tr>
                            </thead>
    ...
    <div class="fixed inset-0 overflow-hidden z-[100] hidden" id="ModalCambiarPrecioPesada">
        <div class="flex justify-center items-center w-full min-h-screen h-full py-4 px-4 text-center">
            ...
            <!-- Contenido del modal -->
            <div
                class="absolute rounded-lg max-h-max inset-0 m-auto align-bottom bg-white dark:bg-gray-700 text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg w-full">
                <div class="p-4">
                        ...
                        <div class="mt-4 flex justify-center items-center flex-col gap-4">
                            ...
                            <div class="relative flex w-full justify-center max-w-xs">
                                ...
                                <div class="w-full relative">
                                    ...
                                    <div id="contenedorDeClientes2"
                                        class="w-full max-h-60 border border-gray-300 rounded-lg absolute hidden overflow-auto text-sm divide-y divide-gray-200 bg-white dark:bg-gray-800">
                                    </div>
                                </div>
                                <div id="clienteSeleccionadoCorrecto2"
                                    class="ml-1 hidden justify-center items-center px-2 text-white bg-green-500 text-sm border border-gray-300 rounded-md dark:border-gray-600">
                                    <i class='bx bx-check text-xl'></i>
                                </div>
                            </div>
                            ...
                            <input type="date"
                                class="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 px-2.5 py-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full md:w-80"
                                id="fechaCambiarPrecioPesada">
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead class="text-xs text-gray-100 uppercase bg-blue-600">
                                        <tr>
                                            ...
                                            <th class="p-4 border-l-2 border-t-2 border-r-2 border-b-2 whitespace-nowrap">
                                                Nombre de Especie</th>
                                            <th class="p-4 border-r-2 border-t-2 border-b-2 text-center whitespace-nowrap">
                                                Nuevo Precio</th>
                                            <th
                                                class="p-4 border-r-2 border-t-2 border-b-2 text-center whitespace-nowrap hidden">
                                                Id Especie</th>
                                        </tr>
                                    </thead>
                ...
                <div class="px-4 pb-4">
                    <div class="border-t dark:border-gray-500 w-full sm:flex sm:flex-row-reverse pt-4">
                        <button type="button"
                            class="flex w-full justify-center items-center gap-1 rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 sm:ml-3 sm:w-auto"
                            id="btnCambiarPrecioPesada">Cambiar</button>
                        <button type="button"
                            class="mt-3 inline-flex w-full justify-center rounded-md bg-red-500 hover:bg-red-600 px-3 py-2 text-sm font-semibold text-gray-100 sm:mt-0 sm:w-auto cerrarModalCambiarPrecioPesada">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="fixed inset-0 overflow-y-auto z-[100] hidden" id="ModalAgregarDescuentoCliente">
        <div class="flex justify-center items-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <!-- Contenido del modal -->
            <div
                class="absolute rounded-lg max-h-max inset-0 m-auto align-bottom bg-white dark:bg-gray-700 text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                <div class="p-4">
                    <div class="flex flex-col">
                        <div class="border-b rounded-t dark:border-gray-500 p-2 flex justify-center">
                        ...
                        <div class="mt-4 flex justify-center items-center flex-col gap-4" id="divAgregarDescuentoCliente">
                            ...
                            <div class="relative flex w-full justify-center">
                                ...
                                <div class="w-full relative">
                                    ...
                                    <div id="contenedorDeClientes3"
                                        class="w-full max-h-60 border border-gray-300 rounded-lg absolute hidden overflow-auto text-sm divide-y divide-gray-200 bg-white dark:bg-gray-800">
                                    </div>
                                </div>
                                <div id="clienteSeleccionadoCorrecto3"
                                    class="ml-1 hidden justify-center items-center px-2 text-white bg-green-500 text-sm border border-gray-300 rounded-md dark:border-gray-600">
                                    <i class='bx bx-check text-xl'></i>
                                </div>
                            </div>
                            ...
                            <div class="flex w-full justify-start items-center gap-2">
                                <h5 for="fechaAgregarDescuento"
                                    class="text-base text-gray-900 dark:text-gray-50 min-w-max">Fecha :</h5>
                                <input type="date"
                                    class="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 px-2.5 py-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full"
                                    id="fechaAgregarDescuento">
                            </div>
                            <div class="flex w-full h-10">
                                <div
                                    class="text-sm px-3 flex items-center justify-center text-center border border-gray-300 dark:border-gray-600 bg-gray-300 dark:bg-gray-600 rounded-l-lg">
                                    <h4 class="font-medium text-gray-900 dark:text-gray-300 min-w-max">Presentación</h4>
                                </div>
                                <select
                                    class="w-full uppercase outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    name="presentacionAgregarDescuentoCliente" id="presentacionAgregarDescuentoCliente">
                            ...
                            <div class="flex w-full h-10">
                                ...
                                <input
                                    class="validarCampo validarSoloNumerosDosDecimales w-full uppercase outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-r-lg"
                                    type="text" name="valorAgregarDescuentoCliente" placeholder="0.0"
                                    autocomplete="off" id="valorAgregarDescuentoCliente" value="">
                            </div>
                            <div class="flex w-full h-10">
                                <div
                                    class="text-sm px-3 flex items-center justify-center text-center border border-gray-300 dark:border-gray-600 bg-gray-300 dark:bg-gray-600 rounded-l-lg">
                                ...
                                <input
                                    class="validarCampo validarSoloNumerosDosDecimales w-full uppercase outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-r-lg"
                                    type="text" name="valorPrecioDescuento" autocomplete="off"
                                    id="valorPrecioDescuento" value="" placeholder="0.0">
                            </div>
                            <div class="flex flex-col w-full">
                                <label for="comentarioAgregarDescuentoCliente"
                                    class="mb-2 text-sm font-medium text-gray-900 dark:text-white md:w-24">Comentario
                                    :</label>
                                <textarea
                                    class="w-full outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="text" name="comentarioAgregarDescuentoCliente" autocomplete="off"
                                    id="comentarioAgregarDescuentoCliente"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="px-4 pb-4">
                    <div class="border-t dark:border-gray-500 w-full sm:flex sm:flex-row-reverse pt-4">
                        <button type="button"
                            ...
                            id="btnAgregarDescuentoCliente">Registrar</button>
                        <button type="button"
                            class="mt-3 inline-flex w-full justify-center rounded-md bg-red-500 hover:bg-red-600 px-3 py-2 text-sm font-semibold text-gray-100 sm:mt-0 sm:w-auto cerrarModalAgregarDescuentoCliente">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
