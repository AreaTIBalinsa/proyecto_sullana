...
<div class="fixed inset-0 overflow-hidden z-[100] hidden" id="ModalEditarDatosdeCliente">
    <div class="flex justify-center items-center w-full min-h-screen py-4 px-4 text-center">
        ...
        <!-- Contenido del modal -->
        <div class="rounded-lg max-h-[100%] aside_scrollED overflow-hidden overflow-y-auto bg-white dark:bg-gray-700 text-left shadow-xl transform transition-all max-w-[700px] w-full">
            <div class="p-4">
