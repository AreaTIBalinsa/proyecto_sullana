        ...
        <div class="w-full md:px-5 md:pb-5">
            ...
            <div class="flex flex-col gap-3 md:flex-row justify-between items-end">
                ...
                <div class="relative w-full md:w-auto">
                    <button
                        class="select-none rounded-lg bg-green-600 py-2.5 px-6 text-center align-middle font-sans text-xs font-semibold uppercase text-white transition-all focus:opacity-[0.85] active:opacity-[0.85] w-full md:w-auto"
                        type="button" id="agregarEgresoBtn"
                    ><i class="fa-solid fa-table"></i>&nbsp;&nbsp;Agregar Ingreso
                    </button>
                </div>
            </div>
